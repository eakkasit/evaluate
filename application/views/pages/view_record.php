		...
		<div class="widget-main">
			<div class="row">
				<div class="col-md-12 text-right">
					...
					<a href="<?php echo base_url("records/dashboard_records"); ?>"
					   class="table-link" title="ย้อนกลับ">
						<button type="button" class="btn btn-xs btn-info">
							<i class="fa fa-arrow-left"></i> ย้อนกลับ
						</button></a>

					<?php if (in_array(strtolower($meeting_data->meeting_status), array('active'))) { ?>
						<a href="#"
						   class="table-link"
						   onclick="complete_meeting(<?php echo $meeting_data->meeting_id; ?>);" title="สิ้นสุดการประชุม">
				...
				<tr class="odd" role="row">
					...
					<td class="text-center white">
						<div>
							...
							<a href="<?php echo base_url("records/edit_record/{$meeting_data->meeting_id}/{$agenda->agenda_id}"); ?>"
							   class="table-link" title="แก้ไขบันทึกการประชุม">
								<button type="button" class="btn btn-xs btn-warning">
									<i class="fa fa-edit"></i> แก้ไขบันทึกการประชุม
								</button></a>
