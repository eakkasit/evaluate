			...
			foreach ($meetings as $key => $meeting) {
				...
				<tr class="odd" role="row">
					...
					<td class="text-center white">
						<div>
							<a href="<?php echo base_url("attends/view_attend/{$meeting->meeting_id}"); ?>"
							   class="table-link" title="แสดงการประชุม">
								<button type="button" class="btn btn-xs btn-info">
									<i class="fa fa-eye"></i> แสดงการประชุม
								</button></a>

							<!-- <?php if ($meeting->agenda_id != '') { ?>
								<a href="<?php echo base_url("attends/edit_attend/{$meeting->meeting_id}/{$meeting->agenda_id}"); ?>"
								   class="table-link" title="เข้าร่วมการประชุม">
									<button type="button" class="btn btn-xs btn-primary">
										<i class="fa fa-briefcase"></i> เข้าร่วมการประชุม
									</button></a>
							<?php } ?> -->
						</div>
					</td>
